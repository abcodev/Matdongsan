                                ...
                                <tr style="background-color: #fdf0f0">
                                    <td onclick="movePage(${qn.qnaBno})">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-megaphone" viewBox="0 0 16 16">
                                            ...
                                            ${qn.qnaTitle}</td><td>${qn.qnaWriter}</td><td>${fn:substring(qn.qnaDate, 0, 16)}</td><td>${qn.count}
                                    </td>
                                </tr>
                        </c:forEach>
                                    ...
                                    <tr class="tdBody">
                                        <td onclick="movePage(${qb.qnaBno})">
                                            ...
                                            <c:if test="${qb.qnaArea != null}">
                                                (${qb.qnaArea})
                                            </c:if>${qb.qnaTitle}</td><td>${qb.qnaWriter}</td><td>${fn:substring(qb.qnaDate, 0, 16)}</td><td>${qb.count}
                                        </td>
                                    </tr>
                                </c:if>
