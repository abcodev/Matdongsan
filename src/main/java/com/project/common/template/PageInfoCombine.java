...
public class PageInfoCombine {
    ...
    public PageInfoCombine(int listCount, int currentPage) {
        this(listCount, currentPage, 10, 10);
    }

    public PageInfoCombine(int listCount, int currentPage, int boardLimit) {
        this(listCount, currentPage, 10, boardLimit);
    }

    public PageInfoCombine(int listCount, int currentPage, int pageLimit, int boardLimit) {
