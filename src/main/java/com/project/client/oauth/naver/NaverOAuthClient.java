...
public class NaverOAuthClient implements OAuthClient {
    ...
    private final static String REDIRECT_URI = "http://localhost:8070/Matdongsan/callback";
    ...
    public OAuthUser getUserProfile(HttpSession session, String code, String state) {
        ...
        try {
            ...
            return new OAuthUser("NAVER", Long.parseLong(providerId), name, email, profileImage);
