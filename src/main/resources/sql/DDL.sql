...
COMMENT
    ON COLUMN "REALEATATE_SELL"."SGG_CD" IS '자치구코드';

COMMENT
    ON COLUMN "REALEATATE_SELL"."SGG_NM" IS '자치구명';

COMMENT
    ON COLUMN "REALEATATE_SELL"."BJDONG_CD" IS '법정동코드';

COMMENT
    ON COLUMN "REALEATATE_SELL"."BJDONG_NM" IS '법적동명';

COMMENT
    ON COLUMN "REALEATATE_SELL"."BONBEON" IS '본번';

COMMENT
    ON COLUMN "REALEATATE_SELL"."BUBEON" IS '부번';
...
(
    "RENT_NO"      VARCHAR(255) NOT NULL,
    "ACC_YEAR"     VARCHAR(255) NULL,
    "SGG_CD"       VARCHAR2(255) NULL,
    "SGG_NM"       VARCHAR(255) NULL,
    "BJDONG_CD"    VARCHAR2(255) NULL,
    "BJDONG_NM"    VARCHAR(255) NULL,
    "BOBN"         VARCHAR2(255) NULL,
    "BUBN"         VARCHAR2(255) NULL,
    "DEAL_YMD"     VARCHAR(255) NULL,
    "RENT_GBN"     VARCHAR(255) NULL,
    "RENT_AREA"    VARCHAR(255) NULL,
    "RENT_GTN"     VARCHAR(255) NULL,
...
COMMENT
    ON COLUMN "REALESTATE_RENT"."SGG_CD" IS '자치구 코드';

COMMENT
    ON COLUMN "REALESTATE_RENT"."SGG_NM" IS '자치구명';

COMMENT
    ON COLUMN "REALESTATE_RENT"."BJDONG_CD" IS '법적동 코드';
...
(
    ...
    "GRADE"         VARCHAR(10) DEFAULT 1   NULL
);
